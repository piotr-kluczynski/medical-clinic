        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Room = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    DiagnosisTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Symptoms = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Illness = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Condition = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Value = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    PurchaseDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    LastInspection = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Description = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Day = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    StartHour = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    EndHour = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
